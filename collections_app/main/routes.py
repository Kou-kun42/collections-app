...
from collections_app.models import Game, Console, Collection, User
from collections_app.main.forms import GameForm, ConsoleForm, CollectionForm
from collections_app import bcrypt
from collections_app import app, db
